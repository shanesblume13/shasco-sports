    ...
    return teams.when(
      data: (teams) {
        ...
        return imagePaths.when(
          data: (imagePaths) {
            AsyncValue<Pick?> pick =
                ref.watch(pickByMatchupStateProvider(matchup));
            ...
            Team awayTeam = teams.firstWhere(
                (team) => matchup.awayTeamReference == team.reference);
            Team homeTeam = teams.firstWhere(
                (team) => matchup.homeTeamReference == team.reference);
            ...
            return pick.when(
                        ...
                        gridArea('awayLogo').containing(
                          InkWell(
                            ...
                            child: TeamImageContainer(
                              isPicked:
                                  pick?.teamReference == awayTeam.reference,
                              team: awayTeam,
                              isHome: false,
                        ...
                        gridArea('scoreDivider').containing(
                          InkWell(
                            ...
                            child: MatchupPickScoreDivider(
                              homePicked:
                                  pick?.teamReference == homeTeam.reference,
                              awayPicked:
                                  pick?.teamReference == awayTeam.reference,
                              points:
              ...
              error: (e, s) =>
                  const Center(child: Text('Error getting images!')),
            );
          },
          loading: () => const Center(child: CircularProgressIndicator()),
